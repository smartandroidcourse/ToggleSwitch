...
public class ToggleSwitchButton extends View {
    ...
    private ToggleDrawable mHandleDrawable;
    private ToggleDrawable mOuterRing;

    private ToggleDrawable upper;
    private ToggleDrawable bottom;
    ...
    public ToggleSwitchButton(Context context, AttributeSet attrs) {
        ...
        mHandleDrawable = new ToggleDrawable(res, getResourceId(a, R.styleable.ToggleSwitchButton_handleDrawable));
        upper = new ToggleDrawable(res, getResourceId(a, R.styleable.ToggleSwitchButton_upper));
        bottom = new ToggleDrawable(res, getResourceId(a, R.styleable.ToggleSwitchButton_bottom));

        mOuterRing = new ToggleDrawable(res, R.drawable.ic_switch_shape);
